...
class ImageQualityClassifier(object):
    ...
    def _probabilities_from_image(self, image_placeholder,
        ...
        model_metrics = codex.miq.evaluation.get_model_and_metrics(
            tiles,
    ...
    def predict(self, image):
        ...
        return codex.miq.evaluation.aggregate_prediction_from_probabilities(
            np_probabilities, codex.miq.evaluation.METHOD_AVERAGE)
    ...
    def get_patch_predictions(self, image):
        ...
        """
        results = []
        w = codex.miq.constants.PATCH_SIDE_LENGTH
    ...
    def get_annotated_prediction(self, image):
        ...
        return numpy.squeeze(
            codex.miq.evaluation.visualize_image_predictions(
                np_patches,
                np_probabilities,
                np_labels,
                image.shape[0],
