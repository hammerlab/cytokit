...
ENV_APP_MAX_KDE_CELLS = 'APP_MAX_KDE_CELLS'
...
ENV_APP_MONTAGE_CYCLE = 'APP_MONTAGE_CYCLE '
ENV_APP_MONTAGE_Z = 'APP_MONTAGE_Z'
ENV_APP_MONTAGE_GRID_ENABLED = 'APP_MONTAGE_GRID_ENABLED'
ENV_APP_MONTAGE_GRID_COLOR = 'APP_MONTAGE_GRID_COLOR'
...
class AppConfig(object):
    ...
    @property
    def debug(self):
        return os.getenv(ENV_APP_DEBUG, 'false').lower() == 'true'
    ...
    def montage_grid_color(self):
        return os.getenv(ENV_APP_MONTAGE_GRID_COLOR, DEFAULT_APP_MONTAGE_GRID_COLOR)
    ...
    @property
    def max_kde_cells(self):
        return int(os.getenv(ENV_APP_MAX_KDE_CELLS, DEFAULT_MAX_KDE_CELLS))
